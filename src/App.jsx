    ...
    <>
       <div className='d-flex justify-content-center align-items-center' id='bmi' style={{width:'100', height:'100vh'}}>
        <div className='p-5 rounded shadow' id='div1' style={{width:'500px'}}>
          <h1 className='text-center'> <span className='text-dark'> BMI </span>Calculator</h1>
          <p className='text-center fw-bolder mt-3'>Calculate Your <span className='text-dark ms-2'> BMI </span></p>
